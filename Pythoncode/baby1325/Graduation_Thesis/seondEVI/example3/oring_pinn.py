...
def Q_grad(x1,y1,net):
        ...
        cond3=10*(torch.sin(4*np.pi*x1)+torch.cos(4*np.pi*y1)).float().to(device)
...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/pinn44.png")
        plt.close()
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/pinnszj.png")
torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/model/modeltesto1_{}.pkl".format(2))
# 计算后验误差指标
