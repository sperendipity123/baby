...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/solve.png')
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/abs error.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/Possion PINN SAIS x at 0.5.png') 
...
while 0.5*error >2*Posterior_error:
    ...
    while s <= T_max:
        ...
        plt.yscale("log")
        plt.legend(prop = {'size':6})
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/2000_moloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/2000_mo44.png")
        plt.close()
        # 更新学习率
        """ scheduler.step() """
        if s%100==0:
        ...
        if s%e ==1 and s>=2:
            ...
            #  fig.colorbar(h, cax=cax)
                ...
                plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/2000_mo43.png")
                plt.close()
    ...
    plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image3/2000_moszj.png")
    torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/model/modeltestmo10_{}.pkl".format(2000))
    # 计算后验误差指标
