...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/example2 solve.png')
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/example2 abs error.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/example2 PINN x at 0.5.png') 
...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/pinn44.png")
        plt.close()
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/image/pinnszj.png")
torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/model/PINN_modeltesto2_{}.pkl".format(1))
# 计算后验误差指标
