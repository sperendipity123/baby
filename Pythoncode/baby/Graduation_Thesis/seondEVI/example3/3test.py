...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/solve.png')
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/abs error.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/examlpe3 RPINN SAIS x at 0.5.png') 
...
while error >gamma_0**2+h1**2+Posterior_error:
    ...
    # 定义优化器和学习率
    optimizer1 = torch.optim.Adam(Rnet.parameters(), lr=0.01,betas=(0.9, 0.999), eps=1e-8, weight_decay=0, amsgrad=False)
    ...
    for i in range(T_max2):
        ...
        plt.yscale("log")
        plt.legend(prop = {'size':6})
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/newloss32.png")
        plt.close()
        u_pred_fig = u_pred.reshape(h,h)
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/newpinn44.png")
        plt.close()
    # 计算后验误差指标
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/RPINNszj.png")
