...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1solve.png')
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1abs error.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1example3 x at 0.5.png') 
...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1pinn44.png")
        plt.close()
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/1pinnszj.png")
torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/model/PINN_modeltestor3_{}.pkl".format(5000))
# 计算后验误差指标
