...
# Data Prep
data_finte = scipy.io.loadmat('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/data/example3.mat')  # note change
...
def l_interior(x1,y1,cond1,net,model):
        ...
        cond =(torch.abs(3*x1-1)+2*torch.sign(2*y1-1)+2*torch.sign(x1-0.75)+5*torch.sin(6*np.pi*x1)).float().to(device)
...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/solve.png')
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/abs error.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image/example3 x at 0.5.png') 
...
model.load_state_dict(torch.load("Graduation_Thesis/seondEVI/example3/model/PINN_modeltestor3_3.pkl"))
# 新的网络
net = Newnet(layers2).to(device)
# 定义优化器和学习率
optimizer = torch.optim.Adam(net.parameters(), lr=0.01,betas=(0.9, 0.999), eps=1e-8, weight_decay=0, amsgrad=False)
...
# 读取数据
data_real = scipy.io.loadmat('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/data/highapprox.mat')  # note change
...
# 读取数据
data_Posterior = scipy.io.loadmat('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/data/Posterior.mat')  # note change
...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/pinn44.png")
        plt.close()
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example3/image1/pinnszj.png")
