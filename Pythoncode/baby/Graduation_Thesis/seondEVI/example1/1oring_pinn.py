...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/imagetest/solve.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example2/imagetest/Possion PINN SAIS x at 0.5.png') 
...
#初始化 数据
epochs = 50000  # 训练代数   #迭代足够了 1000个点也可以
...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/5pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/5pinn44.png")
        plt.close()
...
# plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/pinnszj.png")
torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/model/PINN_modeltestortest_{1}.pkl".format(5))
# 计算后验误差指标
