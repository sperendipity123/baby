...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    fig.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image/3The numerical solution.jpg")
    ...
    # plt.show()
    fig.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image/3High approximate solution.jpg")
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image/3Abs error.jpg")
