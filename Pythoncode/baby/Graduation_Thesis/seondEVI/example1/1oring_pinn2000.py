...
for i in range(T_max):
        ...
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/2000pinnloss32.png")
        plt.close()
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/2000pinn44.png")
        plt.close()
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/imagetest/2000pinnszj.png")
torch.save(net.state_dict(),"/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/model/PINN_modeltestortest2_2.pkl")
# 计算后验误差指标
