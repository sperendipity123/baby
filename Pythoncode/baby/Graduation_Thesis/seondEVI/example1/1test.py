...
def solutionplot(u_pred_fig,u_error_fig,u_real_fig):
    ...
    cax = divider.append_axes("right", size="5%", pad=0.05)
    fig.colorbar(h, cax=cax)
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/solve.png')
    ...
    plt.savefig('/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/examlpe1 RPINN SAIS x at 0.5.png') 
...
while error >gamma_0**2+h1**2+Posterior_error:
    ...
    for i in range(T_max):
            ...
            plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/pinnloss32.png")
            plt.close()
            ...
            # plt.xlim(0,1.1)
            # plt.ylim(-0.5,0.1)
            plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/pinn44.png")
            plt.close()
    for i in range(T_max2):
        ...
        plt.yscale("log")
        plt.legend(prop = {'size':6})
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/newloss32.png")
        plt.close()
        u_pred_fig = u_pred.reshape(h,h)
        ...
        # plt.xlim(0,1.1)
        # plt.ylim(-0.5,0.1)
        plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/newpinn44.png")
        plt.close()
    # 计算后验误差指标
...
plt.savefig("/home/pengyaoguang/baby/Graduation_Thesis/seondEVI/example1/image2/RPINNszj.png")
